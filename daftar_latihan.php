...
?>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-lg-between">
      ...
      <h1 class="logo me-auto me-lg-0 ">Daftar Latihan Karate-Do Gojukai DIY</h1>
    ...
    <div class="table-container">
        <table>
            ...
            <?php
                include 'koneksi.php';
                $query=mysqli_query($connection, "select * from latihan");
                while($data=mysqli_fetch_array($query))
                {?>
                    <tr>
                        <td class="text-center"> <?php echo $data['id_latihan']; ?></td>
                        ...
                        <form method="post" action="">
                            <input type="hidden" name="id_latihan" value="<?php echo $data['id_latihan']; ?>"><br>
