...
<?php session_start();
    ...
    $query=mysqli_query($connection, "UPDATE pertandingan SET 
                     Nama='$Nama',Tanggal='$Tanggal',Tempat='$Tempat' where id_pertandingan='$id_pertandingan'")
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-lg-between">
      ...
      <h1 class="logo me-auto me-lg-0 ">Daftar Pertandingan Karate-Do Gojukai </h1>
    ...
    <div class="table-container">
        <table>
            ...
            <?php
                include 'koneksi.php';
                $query=mysqli_query($connection, "select * from pertandingan");
                while($data=mysqli_fetch_array($query))
                {?>
                    <tr>
                        <td class="text-center"> <?php echo $data['id_pertandingan']; ?></td>
                        <td class="text-center"> <?php echo $data['Nama']; ?></td>
                        <td class="text-center"> <?php echo $data['Tanggal']; ?></td>
                        <td class="text-center"> <?php echo $data['Tempat']; ?></td>
                        <td>
                        <form method="post" action="">
                            <input type="hidden" name="id_pertandingan" value="<?php echo $data['id_pertandingan']; ?>"><br>
